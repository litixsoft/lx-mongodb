 ...
 * @constructor
 */
module.exports.GetDb = function (connectionString, collections) {
    var dbName;
 ...
 * @constructor
 */
module.exports.BaseRepo = function (collection) {
    if (!collection) {
     ...
     * @param {number=} options.skip The skip option.
     * @param {number=} options.limit The limit option.
     * @param {Object=|Array=} options.fields The fields which are returned in the documents.
     * @param {String=} options.sortBy The sort field.
     * @param {number=} options.sort The sort direction.
     * @param {function(err, res)=} cb The callback.
     */
    pub.getAll = function (query, options, cb) {
        ...
        var mongoOptions = {
            ...
            sort: [
                [options.sortBy || defaultSortField, options.sort || 1]
            ]
        };
        ...
        validate(doc, true, function (err, res) {
            if (err) {
                ...
                if (!(doc instanceof UpdateCommand)) {
                    // todo check waht is better
                    updateCommand = new UpdateCommand();
//                    updateCommand = require('./updateCommand.js').UpdateCommand();
