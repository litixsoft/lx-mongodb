...
module.exports = function (collection, schema) {
    ...
    function analyseSchema (schema, namespace) {
        ...
        lxHelpers.forEach(schema, function (propertyName, propertyValue) {
    ...
    pub.getCount = function (query, callback) {
        console.warn('The function "getCount()" is deprecated! It will be removed in version 0.6.0. Use "count()" instead.');
    ...
    pub.create = function (doc, callback) {
        console.warn('The function "create()" is deprecated! It will be removed in version 0.6.0. Use "insert()" instead.');
    ...
    pub.getAll = function (query, options, callback) {
        console.warn('The function "getAll()" is deprecated! It will be removed in version 0.6.0. Use "find()" instead.');
    ...
    pub.getOne = function (query, options, callback) {
        console.warn('The function "getOne()" is deprecated! It will be removed in version 0.6.0. Use "findOne()" instead.');
     ...
     * @param {array|object} options.fields The fields which returns from the query.
     * @param {function(err, res)=} callback The callback.
     * @deprecated Use findOneById().
     */
    pub.getOneById = function (id, options, callback) {
        console.warn('The function "getOneById()" is deprecated! It will be removed in version 0.6.0. Use "findOneById()" instead.');
    ...
    pub.delete = function (query, callback) {
        console.warn('The function "delete()" is deprecated! It will be removed in version 0.6.0. Use "remove()" instead.');
