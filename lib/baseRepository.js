...
module.exports = function (collection, schema) {
    ...
    function checkGetAllParameters (query, options, cb) {
        if (typeof query !== 'object') {
            throw new TypeError('query must be of object type');
        }
    ...
    pub.getOneById = function (id, options, cb) {
        ...
        if (!id) {
            cb(new TypeError('id must be of type string or object'), null);
            return;
        }
    ...
    pub.update = function (query, update, cb) {
        ...
        collection.update(query, update, {w: 1}, cb);
    };
    ...
    pub.delete = function (query, cb) {
        ...
        query = convertToMongoId(query);
        collection.remove(query, {w: 1}, cb);
    };
